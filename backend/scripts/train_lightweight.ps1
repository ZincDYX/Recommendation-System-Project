...
param(
    ...
    [int]$MovieLensItemcfHistory = 200,
    [int]$AmazonItemcfHistory = 100,
    [int]$ItemcfTopkNeighbors = 200,
    [int]$ItemcfUserRecentK = 50,
    [int]$ContentMaxFeatures = 50000,
    [int]$ContentMaxUserHistory = 80,
    [int]$Seed = 2026,
